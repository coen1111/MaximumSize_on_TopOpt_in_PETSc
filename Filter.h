...
private:
    ...
    // ========================== MAXIMUM SIZE ==============================
    Mat DII; 			// Maximum size matrix
    Vec Avcorr; 		// Correction for the amount of voids in the boundaries
	Vec Vv; 			// voids with penalization
	Vec dVvdxPhys; 		
	Vec Av; 			// Fraction of voids
	Vec smax; 			// 
	Vec dAggdx;			//
	PetscScalar Agg;    // Aggregation of the local constraints
	// ROBUST:
	Mat DII_DIL;
	Vec Avcorr_DIL;
    // ======================================================================
	...
	// NEW FOR PROJECTION WITH LOOP ============================================================
	// =========================================================================================
	PetscScalar Projection(PetscScalar xFiltered, PetscScalar Beta, PetscScalar eta);
	PetscScalar ProjectionSensitivity(PetscScalar xFiltered, PetscScalar Beta, PetscScalar eta);
	PetscScalar VolDil, VolInt;
	// =========================================================================================
	// =========================================================================================
